define({ "api": [
    ...
    "permission": [
      {
        ...
        "description": "Custom Markdown Parser: Optionally you can write here further Information about the permission.  An \"apiDefinePermission\"-block can have an \"apiVersion\", so you can attach the block to a specific version."
      }
    ],
  ...
  },
  {
    ...
    "description": "Custom Markdown Parser: In this case \"apiErrorStructure\" is defined and used. Define blocks with params that will be used in several functions, so you don't have to rewrite them.",
    "query": [
      {
        "group": "Query",
        "type": "String",
