 ...
 *
 * @param {Array<Array<object>>} parsedFiles - An array of parsed files, where each file contains an array of blocks.
...
function postProcess(parsedFiles /*, filenames, preProcess, packageInfos */) {
  ...
  parsedFiles.forEach(function (parsedFile) {
    parsedFile.forEach(function (block) {
      // Ignore global name, or nonexisting global names (that will be generated with this func)
