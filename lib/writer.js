...
class Writer {
  ...
  createOutputFiles () {
    ...
    this.fs.copySync(this.path.join(this.opt.template, 'src/vendor/bootstrap/css/bootstrap.min.css'), this.path.join(assetsPath, 'bootstrap.min.css'));
    this.fs.copySync(this.path.join(this.opt.template, 'src/vendor/bootstrap/css/bootstrap.min.css.map'), this.path.join(assetsPath, 'bootstrap.min.css.map'));
  ...
  createSingleFile () {
    ...
    // get all css content
    const bootstrapCss = this.fs.readFileSync(this.path.join(this.opt.template, 'src/vendor/bootstrap/css/bootstrap.css'), 'utf8');
