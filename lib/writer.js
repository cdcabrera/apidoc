...
class Writer {
  ...
  getIndexContent() {
    ...
    // Base64 encode images from template/img directory
    const imageTokens = {};
  ...
  /**
   * Creates a self-contained single HTML file by bundling CSS and JavaScript into the file.
   * It modifies the main index HTML content to embed CSS and JavaScript directly, removes external links
   * to these assets, and saves the final file to the destination directory.
   *
