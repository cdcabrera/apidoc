...
class Writer {
  ...
  createOutputFiles() {
    ...
    this.fs.copySync(this.path.join(this.opt.template, 'src/vendor/bootstrap/fonts'), assetsPath);
    ...
    this.fs.copySync(
      this.path.join(this.opt.template, 'src/vendor/bootstrap/css/bootstrap.min.css'),
      this.path.join(assetsPath, 'bootstrap.min.css')
    );
    ...
    this.fs.copySync(
      this.findAsset('prismjs/plugins/toolbar/prism-toolbar.css'),
      this.path.join(assetsPath, 'prism-toolbar.css')
    );
    this.fs.copySync(
      this.findAsset('prismjs/plugins/diff-highlight/prism-diff-highlight.css'),
      this.path.join(assetsPath, 'prism-diff-highlight.css')
    );
    this.log.verbose('Copying main css to: ' + assetsPath);
    // main.css
    this.fs.copySync(
      this.path.join(this.opt.template, 'src', 'css', 'main.css'),
      this.path.join(assetsPath, 'main.css')
    );
    // images
  ...
  createSingleFile() {
    ...
    // get all css content
    const bootstrapCss = this.fs.readFileSync(
      this.path.join(this.opt.template, 'src/vendor/bootstrap/css/bootstrap.css'),
      'utf8'
    );
