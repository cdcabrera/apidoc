 ...
 * @param {Array<string>} [options.src] - Array of source paths to process. May be overridden by the configuration file settings.
 * @param {string} [options.dest] - Output directory path
 * @param {string} [options.template] - Template directory path
 * @param {string} [options.lineEnding] - Line-ending format ('CRLF', 'CR', or 'LF')
 * @returns {{
 *     src: Array<string>,
 *     dest: string,
 *     template: string,
 ...
 *     config: string,
 *     apiprivate: boolean,
 *     encoding: string}} Normalized options object
 * @throws {Error} If the provided configuration file path is a directory instead of a file.
 */
